...
function Achievement() {
  ...
  return (
   <div
            ...
            <h1 className='text-4xl md:text-6xl mb-6 md:mb-10 text-[#08fb1d] tracking-wider text-center md:text-left'>ACHIEVEMENTS / PARTICIPATIONS</h1>

           <div className='space-y-1.5 '>
                <div className='bg-white/20 p-3 rounded-xl space-y-2 text-xl'>
                    Participated in   
                ...
                <a href="https://drive.google.com/drive/u/1/folders/1E_jwxDunqDktYG0jZZTJwn4D6rSwKAiU" target='_blank' className='p-5 font-bold text-2xl flex justify-end text-[#08fb1d] hover:duration-700  hover:text-3xl transition-transform duration-900 hover:scale-105'> ⬆️All Certifications</a>
           </div>
            <div className='space-y-1.5'>
                <div className='bg-white/20 p-3 rounded-xl space-y-2 text-xl'>
                ...
                <a href="https://drive.google.com/drive/u/1/folders/18v69sxKQ9Vx5k86dnj1yn-SmjKrOsxXY" target='_blank' className='p-5 font-bold text-2xl flex justify-end text-[#08fb1d] hover:duration-700  hover:text-3xl transition-transform duration-900 hover:scale-105'> ⬆️All Certifications</a>
            </div>
            <div className='space-y-1.5'>
                <div className='bg-white/20 p-3 rounded-xl space-y-2 text-xl'>
                    Built a 
                ...
                <a href="https://drive.google.com/drive/u/1/folders/1RY29YXiXgAv1pI0NGt2iPOLf51cqzKd7" target='_blank' className='p-5 font-bold text-2xl flex justify-end text-[#08fb1d] hover:duration-700  hover:text-3xl transition-transform duration-900 hover:scale-105'> ⬆️All Certifications</a>
            </div>

            <div className='space-y-6'>
                <h2 className='text-3xl font-bold text-[#08fb1d]'>Online Courses</h2>
